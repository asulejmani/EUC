...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x39ca;
...
const uint64_t DIFFICULTY_TARGET                             = 119; // seconds
...
const char     CRYPTONOTE_NAME[]                             = "eurocoins";
...
const int      P2P_DEFAULT_PORT                              = 2905;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 1107;
